...
[Ory client-python Discussions](https://github.com/orgs/ory/discussions) or the
...
[open a well-written issue or discussion](https://github.com/ory/client-python/issues):
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/client-python/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory client-python, please follow these
guidelines:
...
git clone git@github.com:ory/client-python.git
