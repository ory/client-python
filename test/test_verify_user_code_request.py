...
class TestVerifyUserCodeRequest(unittest.TestCase):
    """VerifyUserCodeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyUserCodeRequest:
        """Test VerifyUserCodeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyUserCodeRequest`
        """
        model = VerifyUserCodeRequest()
        if include_optional:
            return VerifyUserCodeRequest(
                challenge = '',
    ...
    def testVerifyUserCodeRequest(self):
        """Test VerifyUserCodeRequest"""
