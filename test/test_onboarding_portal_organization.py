...
class TestOnboardingPortalOrganization(unittest.TestCase):
    """OnboardingPortalOrganization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnboardingPortalOrganization:
        """Test OnboardingPortalOrganization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnboardingPortalOrganization`
        """
        model = OnboardingPortalOrganization()
        if include_optional:
            return OnboardingPortalOrganization(
                base_url = '',
    ...
    def testOnboardingPortalOrganization(self):
        """Test OnboardingPortalOrganization"""
