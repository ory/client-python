...
class TestNormalizedProject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NormalizedProject:
        ...
        """
        model = NormalizedProject()
        if include_optional:
            return NormalizedProject(
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                current_revision = ory_client.models.normalized_project_revision.normalizedProjectRevision(
                    ...
                    kratos_courier_http_request_config_headers = ory_client.models.kratos_courier_http_request_config_headers.kratos_courier_http_request_config_headers(), 
                    ...
                    kratos_courier_smtp_headers = ory_client.models.kratos_courier_smtp_headers.kratos_courier_smtp_headers(), 
                    ...
                    kratos_oauth2_provider_headers = ory_client.models.kratos_oauth2_provider_headers.kratos_oauth2_provider_headers(), 
