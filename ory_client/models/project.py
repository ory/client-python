...
class Project(BaseModel):
    ...
    home_region: StrictStr = Field(description="The project home region.  This is used to set where the project data is stored and where the project's endpoints are located. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global")
    id: UUID = Field(description="The project's ID.")
    name: StrictStr = Field(description="The name of the project.")
    organizations: List[BasicOrganization] = Field(description="The organizations of the project.  Organizations are used to group users and enforce certain restrictions like usage of SSO.")
    ...
    __properties: ClassVar[List[str]] = ["cors_admin", "cors_public", "environment", "home_region", "id", "name", "organizations", "revision_id", "services", "slug", "state", "workspace_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "organizations": [BasicOrganization.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None,
