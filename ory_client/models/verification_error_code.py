...
class VerificationErrorCode(str, Enum):
    ...
    allowed enum values
    """
    VERIFICATION_ERROR_UNSPECIFIED = 'VERIFICATION_ERROR_UNSPECIFIED'
    VERIFICATION_ERROR_INVALID_FORMAT = 'VERIFICATION_ERROR_INVALID_FORMAT'
    VERIFICATION_ERROR_EXPIRED = 'VERIFICATION_ERROR_EXPIRED'
    VERIFICATION_ERROR_REVOKED = 'VERIFICATION_ERROR_REVOKED'
    VERIFICATION_ERROR_NOT_FOUND = 'VERIFICATION_ERROR_NOT_FOUND'
    VERIFICATION_ERROR_SIGNATURE_INVALID = 'VERIFICATION_ERROR_SIGNATURE_INVALID'
    VERIFICATION_ERROR_INTERNAL = 'VERIFICATION_ERROR_INTERNAL'
    VERIFICATION_ERROR_IP_NOT_ALLOWED = 'VERIFICATION_ERROR_IP_NOT_ALLOWED'
    VERIFICATION_ERROR_RATE_LIMITED = 'VERIFICATION_ERROR_RATE_LIMITED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VerificationErrorCode from a JSON string"""
