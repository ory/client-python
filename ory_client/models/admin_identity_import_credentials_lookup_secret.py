...
class AdminIdentityImportCredentialsLookupSecret(BaseModel):
    """
    Create Identity and Import Lookup Secret Credentials
    """ # noqa: E501
    config: Optional[AdminIdentityImportCredentialsLookupSecretConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AdminIdentityImportCredentialsLookupSecretConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
