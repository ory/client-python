...
class OnboardingPortalTestLoginFlow(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the created test login flow. Append this as the `flow` query parameter on the test sign-in UI URL.")
