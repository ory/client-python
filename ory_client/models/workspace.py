...
class Workspace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["access_policy", "created_at", "id", "name", "organization_id", "subscription_id", "subscription_plan", "updated_at"]
