...
class SetProject(BaseModel):
    ...
    organizations: List[BasicOrganization] = Field(description="The organizations that are part of this project.")
    services: ProjectServices
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["cors_admin", "cors_public", "name", "organizations", "services"]
