...
class NormalizedProjectRevisionHook(BaseModel):
    ...
    id: Optional[UUID] = Field(default=None, description="ID of the entry")
    notify_previous_addresses_config_recipients: Optional[StrictStr] = Field(default=None, description="The recipients to be notified in case of a change of the users verified email addresses. Possible values are: \"all\", \"all_verified\", \"removed\" (only notify about removed email addresses)")
    ...
    __properties: ClassVar[List[str]] = ["config_key", "created_at", "hook", "id", "notify_previous_addresses_config_recipients", "project_revision_id", "updated_at", "web_hook_config_auth_api_key_in", "web_hook_config_auth_api_key_name", "web_hook_config_auth_api_key_value", "web_hook_config_auth_basic_auth_password", "web_hook_config_auth_basic_auth_user", "web_hook_config_auth_type", "web_hook_config_body", "web_hook_config_can_interrupt", "web_hook_config_method", "web_hook_config_response_ignore", "web_hook_config_response_parse", "web_hook_config_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hook": obj.get("hook"),
            "id": obj.get("id"),
            "notify_previous_addresses_config_recipients": obj.get("notify_previous_addresses_config_recipients"),
