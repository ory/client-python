...
class NormalizedProjectRevisionSAMLProvider(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["audience_override_base_url", "created_at", "id", "label", "mapper_url", "organization_id", "project_revision_id", "provider_id", "raw_idp_metadata_xml", "state", "updated_at"]
