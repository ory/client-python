...
class NormalizedProjectRevisionSAMLProvider(BaseModel):
    ...
    """ # noqa: E501
    audience_override_base_url: Optional[StrictStr] = None
    ...
    proxy_acs_url: Optional[StrictStr] = None
    proxy_saml_audience_override: Optional[StrictStr] = None
    ...
    valid_to: Optional[List[StrictStr]] = Field(default=None, description="Valid to dates of all signing certs associated with the SAML connection")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["audience_override_base_url", "created_at", "id", "label", "mapper_url", "organization_id", "project_revision_id", "provider_id", "proxy_acs_url", "proxy_saml_audience_override", "raw_idp_metadata_xml", "state", "update_identity_on_login", "updated_at", "valid_to"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if audience_override_base_url (nullable) is None
        # and model_fields_set contains the field
        if self.audience_override_base_url is None and "audience_override_base_url" in self.model_fields_set:
            _dict['audience_override_base_url'] = None
        ...
        # set to None if proxy_acs_url (nullable) is None
        # and model_fields_set contains the field
        if self.proxy_acs_url is None and "proxy_acs_url" in self.model_fields_set:
            _dict['proxy_acs_url'] = None

        # set to None if proxy_saml_audience_override (nullable) is None
        # and model_fields_set contains the field
        if self.proxy_saml_audience_override is None and "proxy_saml_audience_override" in self.model_fields_set:
            _dict['proxy_saml_audience_override'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audience_override_base_url": obj.get("audience_override_base_url"),
