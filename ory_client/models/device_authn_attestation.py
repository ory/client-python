...
class DeviceAuthnAttestation(BaseModel):
    """
    Exactly one of Android / IOS is set, matching the key's DeviceType.
    """ # noqa: E501
    android: Optional[DeviceAuthnAndroidKeyDescription] = None
    ios: Optional[DeviceAuthnIOSAttestation] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["android", "ios"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "android": DeviceAuthnAndroidKeyDescription.from_dict(obj["android"]) if obj.get("android") is not None else None,
            "ios": DeviceAuthnIOSAttestation.from_dict(obj["ios"]) if obj.get("ios") is not None else None
        })
