...
class UiNodeInputAttributesOption(BaseModel):
    """
    ...
    """ # noqa: E501
    value: Optional[Any] = Field(description="The value that will be submitted when this option is picked. It is serialized verbatim from the JSON schema `enum` entry, so it is always a scalar JSON value (string, number, or boolean).")
