...
class TokenPaginationResponseHeaders(BaseModel):
    ...
    x_total_count: Optional[StrictInt] = Field(default=None, description="The X-Total-Count HTTP Header  The `X-Total-Count` header contains the total number of items in the collection.", alias="x-total-count")
