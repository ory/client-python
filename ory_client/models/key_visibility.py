...
class KeyVisibility(str, Enum):
    ...
    allowed enum values
    """
    KEY_VISIBILITY_UNSPECIFIED = 'KEY_VISIBILITY_UNSPECIFIED'
    KEY_VISIBILITY_SECRET = 'KEY_VISIBILITY_SECRET'
    KEY_VISIBILITY_PUBLIC = 'KEY_VISIBILITY_PUBLIC'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of KeyVisibility from a JSON string"""
