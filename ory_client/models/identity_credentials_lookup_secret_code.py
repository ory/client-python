...
class IdentityCredentialsLookupSecretCode(BaseModel):
    """
    Recovery codes can be used once and are invalidated after use.
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="A recovery code")
    used_at: Optional[datetime] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["code", "used_at"]
