...
class SetOrganizationFromOnboardingPortalLinkBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["kratos_selfservice_methods_oidc_config_providers", "kratos_selfservice_methods_saml_config_providers", "revision_id", "scim_clients"]
