...
class BatchVerifyAPIKeysRequest(BaseModel):
    """
    BatchVerifyAPIKeysRequest
    """ # noqa: E501
    requests: Optional[List[VerifyAPIKeyRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [VerifyAPIKeyRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
