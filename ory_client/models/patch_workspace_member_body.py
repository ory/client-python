...
class PatchWorkspaceMemberBody(BaseModel):
    """
    PatchWorkspaceMemberBody
    """ # noqa: E501
    break_glass: Optional[StrictBool] = Field(default=None, description="Whether to enable break-glass recovery for this member.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["break_glass"]
