...
class SettingsFlow(BaseModel):
    ...
    id: UUID = Field(description="ID represents the flow's unique ID. When performing the settings flow, this represents the id in the settings ui's query parameter: http://<selfservice.flows.settings.ui_url>?flow=<id>")
    identity: Identity
    ...
    __properties: ClassVar[List[str]] = ["active", "continue_with", "expires_at", "id", "identity", "issued_at", "organization_id", "request_url", "return_to", "state", "transient_payload", "type", "ui"]
