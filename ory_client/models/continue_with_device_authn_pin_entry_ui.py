...
class ContinueWithDeviceAuthnPinEntryUi(BaseModel):
    """
    ...
    """ # noqa: E501
    action: StrictStr = Field(description="Action will always be `show_pin_entry_ui` show_pin_entry_ui ContinueWithActionShowPINEntryUIString")
    data: ContinueWithDeviceAuthnPinEntryUiData = Field(description="The one-time HPKE-sealed pin_secret material the device opens to bind the user's PIN after a PIN-protected DeviceAuthn enrollment or secret rotation.")
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['show_pin_entry_ui']):
            raise ValueError("must be one of enum values ('show_pin_entry_ui')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ContinueWithDeviceAuthnPinEntryUiData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
