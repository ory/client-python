...
class IdentityWithCredentialsSamlConfig(BaseModel):
    """
    Payload of SAML providers
    """ # noqa: E501
    providers: Optional[List[IdentityWithCredentialsSamlConfigProvider]] = Field(default=None, description="A list of SAML Providers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [IdentityWithCredentialsSamlConfigProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
