...
class RevocationReason(str, Enum):
    ...
    REVOCATION_REASON_KEY_COMPROMISE = 'REVOCATION_REASON_KEY_COMPROMISE'
    REVOCATION_REASON_AFFILIATION_CHANGED = 'REVOCATION_REASON_AFFILIATION_CHANGED'
    REVOCATION_REASON_SUPERSEDED = 'REVOCATION_REASON_SUPERSEDED'
    REVOCATION_REASON_PRIVILEGE_WITHDRAWN = 'REVOCATION_REASON_PRIVILEGE_WITHDRAWN'
