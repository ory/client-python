...
class OAuth2ConsentSession(BaseModel):
    ...
    grant_access_token_audience: Optional[List[StrictStr]] = Field(default=None, description="Audience Granted  GrantedAudience sets the audience the user authorized the client to use. Should be a subset of `requested_access_token_audience`.")
    grant_scope: Optional[List[StrictStr]] = Field(default=None, description="Scope Granted  GrantScope sets the scope the user authorized the client to use. Should be a subset of `requested_scope`.")
