...
class OnboardingPortalOrganization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "kratos_selfservice_methods_oidc_config_providers", "kratos_selfservice_methods_saml_config_providers", "organization_id", "organization_label", "proxy_acs_url", "proxy_oidc_redirect_url", "proxy_saml_audience_override", "proxy_scim_server_url", "revision_id", "scim_clients", "scim_enabled", "sso_enabled"]
