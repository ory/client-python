...
class OnboardingPortalOrganization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "kratos_selfservice_methods_oidc_config_providers", "kratos_selfservice_methods_saml_config_providers", "organization_id", "organization_label", "revision_id", "scim_clients", "scim_enabled", "sso_enabled"]
