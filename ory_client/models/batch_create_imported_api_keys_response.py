...
class BatchCreateImportedApiKeysResponse(BaseModel):
    """
    BatchCreateImportedApiKeysResponse returns per-item results and summary counters.
    """ # noqa: E501
    failure_count: Optional[StrictInt] = None
    results: Optional[List[BatchCreateImportedApiKeysResult]] = None
    success_count: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["failure_count", "results", "success_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [BatchCreateImportedApiKeysResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
