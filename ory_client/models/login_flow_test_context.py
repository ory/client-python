...
class LoginFlowTestContext(BaseModel):
    """
    ...
    """ # noqa: E501
    debug_payload: Optional[LoginFlowTestDebugPayload] = None
    provider_id: StrictStr = Field(description="The ID of the OIDC provider this test flow targets.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["debug_payload", "provider_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of debug_payload
        if self.debug_payload:
            _dict['debug_payload'] = self.debug_payload.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "debug_payload": LoginFlowTestDebugPayload.from_dict(obj["debug_payload"]) if obj.get("debug_payload") is not None else None,
