...
class IdentityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.batch_patch_identities_endpoint = _Endpoint(
            settings={
                'response_type': (BatchPatchIdentitiesResponse,),
                'auth': [
                    'oryAccessToken'
                ],
                'endpoint_path': '/admin/identities',
                'operation_id': 'batch_patch_identities',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def batch_patch_identities(
        ...
        **kwargs
        ...
        Creates or delete multiple [identities](https://www.ory.sh/docs/kratos/concepts/identity-user-model). This endpoint can also be used to [import credentials](https://www.ory.sh/docs/kratos/manage-identities/import-user-accounts-identities) for instance passwords, social sign in configurations or multifactor methods.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.batch_patch_identities(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            patch_identities_body (PatchIdentitiesBody): [optional]
        ...
        return self.batch_patch_identities_endpoint.call_with_http_info(**kwargs)
