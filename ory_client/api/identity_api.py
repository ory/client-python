...
class IdentityApi:
    ...
    def create_test_login_flow(
        ...
        :param create_test_login_flow_body: (required)
        :type create_test_login_flow_body: CreateTestLoginFlowBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_test_login_flow_serialize(
            create_test_login_flow_body=create_test_login_flow_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_test_login_flow_with_http_info(
        self,
        create_test_login_flow_body: CreateTestLoginFlowBody,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_test_login_flow_without_preload_content(
        self,
        create_test_login_flow_body: CreateTestLoginFlowBody,
        _request_timeout: Union[
            None,
    ...
    def _create_test_login_flow_serialize(
        self,
        create_test_login_flow_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_test_login_flow_body is not None:
            _body_params = create_test_login_flow_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/test-login-flows',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_identity_credentials(
        ...
        identifier: Annotated[Optional[StrictStr], Field(description="Identifier is the identifier of the credential to delete. It is required for the `oidc`, `saml`, and `deviceauthn` credential types: for `oidc` and `saml` it selects the provider link to remove, for `deviceauthn` it is the `client_key_id` of the device key to revoke. Find the identifier by calling the `GET /admin/identities/{id}?include_credential={type}` endpoint.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type type: str
        :param identifier: Identifier is the identifier of the credential to delete. It is required for the `oidc`, `saml`, and `deviceauthn` credential types: for `oidc` and `saml` it selects the provider link to remove, for `deviceauthn` it is the `client_key_id` of the device key to revoke. Find the identifier by calling the `GET /admin/identities/{id}?include_credential={type}` endpoint.
        :type identifier: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_identity_by_external_id(
        self,
        external_id: Annotated[StrictStr, Field(description="ExternalID must be set to the ID of identity you want to get")],
        include_credential: Annotated[Optional[List[StrictStr]], Field(description="Include Credentials in Response  Include any credential, for example `password` or `oidc`, in the response. When set to `oidc`, This will return the initial OAuth 2.0 Access Token, OAuth 2.0 Refresh Token, and the OpenID Connect ID Token if available.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param external_id: ExternalID must be set to the ID of identity you want to get (required)
        ...
        _param = self._get_identity_by_external_id_serialize(
    ...
    @validate_call
    def get_identity_by_external_id_with_http_info(
        self,
        external_id: Annotated[StrictStr, Field(description="ExternalID must be set to the ID of identity you want to get")],
        include_credential: Annotated[Optional[List[StrictStr]], Field(description="Include Credentials in Response  Include any credential, for example `password` or `oidc`, in the response. When set to `oidc`, This will return the initial OAuth 2.0 Access Token, OAuth 2.0 Refresh Token, and the OpenID Connect ID Token if available.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_identity_by_external_id_without_preload_content(
        self,
        external_id: Annotated[StrictStr, Field(description="ExternalID must be set to the ID of identity you want to get")],
        include_credential: Annotated[Optional[List[StrictStr]], Field(description="Include Credentials in Response  Include any credential, for example `password` or `oidc`, in the response. When set to `oidc`, This will return the initial OAuth 2.0 Access Token, OAuth 2.0 Refresh Token, and the OpenID Connect ID Token if available.")] = None,
        _request_timeout: Union[
    ...
    def _get_identity_by_external_id_serialize(
        self,
        external_id,
        include_credential,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/identities/by/external/{externalID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def manage_sessions(
        ...
        :param manage_sessions_body: (required)
        :type manage_sessions_body: ManageSessionsBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._manage_sessions_serialize(
            manage_sessions_body=manage_sessions_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def manage_sessions_with_http_info(
        self,
        manage_sessions_body: ManageSessionsBody,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ManageSessionsResponse]:
        """Manage sessions in bulk
    ...
    @validate_call
    def manage_sessions_without_preload_content(
        self,
        manage_sessions_body: ManageSessionsBody,
        _request_timeout: Union[
            None,
    ...
    def _manage_sessions_serialize(
        self,
        manage_sessions_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if manage_sessions_body is not None:
            _body_params = manage_sessions_body
