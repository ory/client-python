...
class V0alpha2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __admin_delete_identity_sessions(
            self,
            id,
            **kwargs
        ):
        ...
        self.admin_delete_identity_sessions = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'oryAccessToken'
                ],
                'endpoint_path': '/api/kratos/admin/identities/{id}/sessions',
            ...
            api_client=api_client,
            callable=__admin_delete_identity_sessions
        )
        ...
        self.create_self_service_logout_flow_url_for_browsers = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/api/kratos/public/self-service/logout/browser',
        ...
        def __get_web_authn_java_script(
            self,
            **kwargs
        ):
        ...
        self.get_web_authn_java_script = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/api/kratos/public/.well-known/ory/webauthn.js',
            ...
            api_client=api_client,
            callable=__get_web_authn_java_script
        )
        ...
        self.list_identity_schemas = _Endpoint(
            settings={
                'response_type': (IdentitySchemas,),
                'auth': [],
                'endpoint_path': '/api/kratos/public/schemas',
            ...
            api_client=api_client,
            callable=__list_identity_schemas
        )
        ...
        self.submit_self_service_logout_flow = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/kratos/public/self-service/logout',
        ...
        self.submit_self_service_logout_flow_without_browser = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/kratos/public/self-service/logout/api',
