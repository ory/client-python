...
class UpdateRegistrationFlowWithCodeMethod(ModelNormal):
    ...
    def _from_openapi_data(cls, method, traits, *args, **kwargs):  # noqa: E501
        """UpdateRegistrationFlowWithCodeMethod - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (str): The OTP Code sent to the user. [optional]  # noqa: E501
            csrf_token (str): The CSRF Token. [optional]  # noqa: E501
            resend (str): Resend restarts the flow with a new code. [optional]  # noqa: E501
