...
class Identity(ModelNormal):
    ...
    def _from_openapi_data(cls, id, schema_id, schema_url, traits, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metadata_admin ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): NullJSONRawMessage represents a json.RawMessage that works well with JSON, SQL, and Swagger and is NULLable-. [optional]  # noqa: E501
            metadata_public ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): NullJSONRawMessage represents a json.RawMessage that works well with JSON, SQL, and Swagger and is NULLable-. [optional]  # noqa: E501
