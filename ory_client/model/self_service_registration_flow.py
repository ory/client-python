...
class SelfServiceRegistrationFlow(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expires_at, id, issued_at, request_url, ui, *args, **kwargs):  # noqa: E501
        """SelfServiceRegistrationFlow - a model defined in OpenAPI
