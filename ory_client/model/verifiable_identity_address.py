...
class VerifiableIdentityAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, value, verified, via, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The ID. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, value, verified, via, *args, **kwargs):  # noqa: E501
        """VerifiableIdentityAddress - a model defined in OpenAPI
