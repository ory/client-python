...
class PlanDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'features': ({str: (GenericUsage,)},),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, base_fee_monthly, base_fee_yearly, custom, description, features, name, version, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            features ({str: (GenericUsage,)}): Features are the feature definitions included in the plan.
        ...
        self.base_fee_monthly = base_fee_monthly
        self.base_fee_yearly = base_fee_yearly
        self.custom = custom
    ...
    @convert_js_args_to_python_args
    def __init__(self, base_fee_monthly, base_fee_yearly, custom, description, features, name, version, *args, **kwargs):  # noqa: E501
        """PlanDetails - a model defined in OpenAPI
