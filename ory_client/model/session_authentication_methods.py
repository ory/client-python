...
class SessionAuthenticationMethods(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SessionAuthenticationMethods - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([SessionAuthenticationMethod]): A list of authenticators which were used to authenticate the session..  # noqa: E501

        Keyword Args:
            value ([SessionAuthenticationMethod]): A list of authenticators which were used to authenticate the session..  # noqa: E501
