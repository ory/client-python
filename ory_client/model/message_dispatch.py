...
class MessageDispatch(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, id, message_id, status, updated_at, *args, **kwargs):  # noqa: E501
        """MessageDispatch - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, id, message_id, status, updated_at, *args, **kwargs):  # noqa: E501
        """MessageDispatch - a model defined in OpenAPI
