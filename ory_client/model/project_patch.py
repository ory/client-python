...
class ProjectPatch(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'kratos_custom_schema_id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, error_ui_url, login_ui_url, lookup_secret, password, recovery, recovery_ui_url, registration_ui_url, session_after_sign_up, session_soft_2fa, settings_privileged_session_max_age_seconds, settings_soft_2fa, settings_ui_url, totp, verification, verification_ui_url, webauthn, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, error_ui_url, login_ui_url, lookup_secret, password, recovery, recovery_ui_url, registration_ui_url, session_after_sign_up, session_soft_2fa, settings_privileged_session_max_age_seconds, settings_soft_2fa, settings_ui_url, totp, verification, verification_ui_url, webauthn, *args, **kwargs):  # noqa: E501
        """ProjectPatch - a model defined in OpenAPI
