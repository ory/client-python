...
class SubmitSelfServiceLoginFlowWithLookupSecretMethodBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, lookup_secret, method, *args, **kwargs):  # noqa: E501
        """SubmitSelfServiceLoginFlowWithLookupSecretMethodBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, lookup_secret, method, *args, **kwargs):  # noqa: E501
        """SubmitSelfServiceLoginFlowWithLookupSecretMethodBody - a model defined in OpenAPI
