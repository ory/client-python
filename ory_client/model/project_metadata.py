...
class ProjectMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, hosts, id, name, state, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, hosts, id, name, state, updated_at, *args, **kwargs):  # noqa: E501
        """ProjectMetadata - a model defined in OpenAPI
