...
class ProjectMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, environment, hosts, id, name, state, updated_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            slug (str): The project's slug. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, environment, hosts, name, state, updated_at, *args, **kwargs):  # noqa: E501
        """ProjectMetadata - a model defined in OpenAPI
